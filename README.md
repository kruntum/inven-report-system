...
2. [คู่มือการใช้งานระบบสำหรับผู้ใช้งาน (User Operation Manual)](#-คู่มือการใช้งานระบบสำหรับผู้ใช้งาน-user-operation-manual)
3. [เทคโนโลยีและเครื่องมือ (Tech Stack & Skills)](#-เทคโนโลยีและเครื่องมือ-tech-stack--skills)
4. [กฎและมาตรฐานการพัฒนา (Development Rules - AGENTS.md)](#-กฎและมาตรฐานการพัฒนา-development-rules---agentsmd)
5. [กระบวนการทำงานตามกฎหมายราชการ (Thai Gov Inventory Workflow)](#-กระบวนการทำงานตามกฎหมายราชการ-thai-gov-inventory-workflow)
6. [การจัดสรรพอร์ตและสถาปัตยกรรม (Port Mapping & Architecture)](#-การจัดสรรพอร์ตและสถาปัตยกรรม-port-mapping--architecture)
7. [วิธีการติดตั้งและเริ่มต้นใช้งาน (Setup & Installation)](#-วิธีการติดตั้งและเริ่มต้นใช้งาน-setup--installation)
8. [ข้อควรระวังและความปลอดภัย (Security & Production Precautions)](#-ข้อควรระวังและความปลอดภัย-security--production-precautions)
9. [รายการคำสั่งที่มีประโยชน์ (Command Reference)](#-รายการคำสั่งที่มีประโยชน์-command-reference)
...
## 📖 คู่มือการใช้งานระบบสำหรับผู้ใช้งาน (User Operation Manual)

*(คุณสามารถกดเข้าดูคู่มือเชิงโต้ตอบฉบับเต็มได้ที่เมนู **"คู่มือการใช้งาน"** บนแถบเมนูด้านข้างของระบบได้เช่นกัน)*

### 1️⃣ การสลับบริษัทและการตั้งค่าข้อมูลหลัก (Setup & Master Data)
* **การสลับบริษัทผู้ประกอบการ:** คลิกที่กล่องเลือกบริษัทที่มุมบนซ้ายของ Sidebar เพื่อสลับการทำงานระหว่างบริษัทต่างๆ ที่ได้รับมอบหมายสิทธิ์
* **การจัดการคลังสินค้า (Storage Locations):** ไปที่เมนู `ข้อมูลสถานที่เก็บสินค้า` เพื่อเพิ่มคลังรับซื้อ/คลังจัดเก็บ (เช่น คลังผลสด, โรงแปรรูป, คลังสินค้าสำเร็จรูป)
* **การจัดการคู่ค้า/เกษตรกร (Partners):** ไปที่เมนู `ข้อมูลคู่ค้า/เกษตรกร` เพื่อเพิ่มรายชื่อเกษตรกรผู้ปลูก ล้งรับซื้อ หรือโรงงานผู้ซื้อ (จำเป็นสำหรับการลงแบบ สกกร. 02)

### 2️⃣ การบันทึกธุรกรรมสต๊อกประจำวัน (Daily Stock Operations)
* ไปที่เมนู **`บันทึกรายการประจำวัน`** แล้วกดปุ่ม **`+ บันทึกธุรกรรมคลังสินค้า`**
* **ระบุประเภทรายการ:**
  * 🟢 **รับซื้อ:** รับซื้อวัตถุดิบผลสดจากเกษตรกร/ล้งผู้ขาย
  * 🔴 **จำหน่าย:** ขายสินค้าออกในประเทศ หรือส่งออกต่างประเทศ
  * 🟡 **ใช้ผลิต:** นำวัตถุดิบเข้ากระบวนการแปรรูปในโรงงาน
  * 🔵 **ปรับปรุงยอด:** ปรับเพิ่ม/ลดสินค้าคงเหลือตามการนับจริง
* **ส่งมอบโดยตรง (ไม่ผ่านคลัง):** ในกรณีเป็นนายหน้า/ผู้ส่งออกที่สั่งซื้อจากโรงงานแล้วส่งออกทันที ให้เช็กถูกช่อง *ส่งมอบโดยตรง* ระบบจะจัดสรรคลังเสมือนให้อัตโนมัติ

### 3️⃣ การตรวจสอบประวัติและสมุดบัญชีคุม (Stock Ledger Inspection)
* ในหน้า **`บันทึกรายการประจำวัน`** สามารถค้นหา กรองตามช่วงวันที่ หรือกรองตามคลังสินค้าได้
* **ดูสมุดบัญชีคุม:** กดปุ่ม **`สมุดบัญชีคุม`** ที่มุมขวาบนของตาราง เพื่อเปิดป๊อปอัปตรวจสอบยอดคงเหลิอยกมา ยอดรับ ยอดจ่าย และยอดคงเหลิอยกไป แยกตามรายสินค้าแบบเรียลไทม์

### 4️⃣ การสรุปและออกรายงานส่งกรมการค้าภายใน (Monthly Government Reporting)
* ไปที่เมนู **`ส่งรายงานราชการรายเดือน`**
* **ประมวลผลคำนวณยอด:** เลือกระบุเดือนและปี พ.ศ. ที่ต้องการ แล้วกดปุ่ม **`ประมวลผลคำนวณยอด`** ระบบจะดึงยอดสะสมทั้งเดือนมาคำนวณลงแบบ **สพภ. 01 และ สพภ. 02** อัตโนมัติ
* **การยื่นส่งและดาวน์โหลด:**
  * กดปุ่ม **`ยื่นส่งรายงาน`** เมื่อตรวจสอบความถูกต้องเรียบร้อยแล้ว
  * กดปุ่ม **`ดาวน์โหลด Excel (สพภ.01/02)`** เพื่อนำไฟล์ไปพิมพ์ส่งกรมการค้าภายในทุกวันที่ 5 ของเดือน
